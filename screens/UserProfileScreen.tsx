            ...
            <StatusBar barStyle={ Platform.OS === 'ios'  ? 'dark-content' : 'light-content'}/>
                ...
                <View style={{backgroundColor: Colors.light.semiSecondary, flex: 1,}}>
                    <View style={styles.bottomContainer}>
                        <View style={{marginBottom:15,}}>
                                ...
                                <View style={styles.imageInnerWrapper}>
                                    {
                                        ...
                                        <Text style={styles.avatarText} >V.M</Text> 
                                        :
                            ...
                            <View style={styles.editButton}>
                                <TouchableOpacity onPress={()=>pickImage()}>
                                    <View>
                                        <Ionicons name="camera-outline" size={26} color={Colors.light.white}/>
                                    </View>
                                </TouchableOpacity>
                            </View>                             
                        </View >
                        ...
                        <TouchableOpacity onPress={()=>toggleBioBottomNavigationView()} activeOpacity={0.4} style={styles.button}>
                                <View style={{flexDirection: "row", alignSelf: "center", flex: 1}}>
                                    <View style={{flex:1}}>
                                    <Text style={{fontSize: 18, fontWeight: "600", marginLeft: 10, color: "#000"}}>Update BIO</Text>
                                    <Text style={{fontSize: 15, marginLeft: 5, marginTop:5, marginBottom:10, color: Colors.light.smoke}}> { bio === "" ? " Please tap to update your bio" : bio } </Text>
                                    </View>
                                </View>
                                <AntDesign color={Colors.light.primary} size={20} style={{alignSelf: "center"}} name="edit"/>
                            </TouchableOpacity>
                            
                            <View style={{height: 10}}/>

                            <TouchableOpacity onPress={()=>toggleBottomNavigationView()} activeOpacity={0.4} style={styles.button}>
                                <View style={{flexDirection: "row", alignSelf: "center", flex: 1}}>
                                    <View style={{flex:1}}>
                                    <Text style={{fontSize: 18, fontWeight: "600", marginLeft: 10, color: "#000"}}>Write your Manifesto</Text>
                                    <Text style={{fontSize: 15, marginLeft: 5, marginTop:5, marginBottom: 10, color: Colors.light.smoke}}>{ reason === "" ? " Please tap to update why you should be elected." : reason } </Text>
                                    </View>
                                </View>
                                <AntDesign color={Colors.light.primary} size={20} style={{alignSelf: "center"}} name="edit"/>
                            </TouchableOpacity>
